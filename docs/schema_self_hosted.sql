-- Funnel ClickHouse Schema (Self-Hosted Edition)
-- Version: 2.0
...
--
-- For ClickHouse Cloud, use schema_cloud.sql instead (projections not supported).
--
-- Usage:
--   Deploy via: ansible-playbook playbooks/schema.yml (with clickhouse_deployment=self_hosted)
--   Or manually: clickhouse-client --multiquery < schema_self_hosted.sql
--
...
-- - Added projections for time, kind, and author query patterns
